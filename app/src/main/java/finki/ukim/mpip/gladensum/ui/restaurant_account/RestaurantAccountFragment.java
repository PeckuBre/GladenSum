...
public class RestaurantAccountFragment extends Fragment {
    ...
    private RestaurantAccountViewModel dashboardViewModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        restaurantAccountViewModel.getRestaurantPicture().observe(this, new Observer<Bitmap>() {
            @Override
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        dashboardViewModel = new ViewModelProvider(this).get(RestaurantAccountViewModel.class);
